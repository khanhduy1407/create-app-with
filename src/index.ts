...
const FRAMEWORKS: Framework[] = [
  {
    ...
    displayName: 'React',
    color: cyan,
    commandRun: 'npx create-react-app TARGET_DIR',
  },
]
...
const defaultTargetDir = 'your-first-project'
...
async function init() {
      ...
      [
        ...
        },
        {
          ...
          choices: FRAMEWORKS.map((framework) => {
            ...
            return {
              title: frameworkColor(framework.displayName || framework.name),
              value: framework,
            }
          }),
        },
  ...
  const { commandRun } = FRAMEWORKS.find((f) => f.name === template) ?? {}

  if (commandRun) {
    const fullCustomCommand = commandRun
      .replace(/^npm create /, () => {
